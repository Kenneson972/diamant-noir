...
2. Sélectionner le fichier `docs/n8n/kayvila-chatbot-v1.json`
...
2. Copier l'URL de production (onglet **Production URL**) :
   ```
   https://kenneson.app.n8n.cloud/webhook/kayvila-chat
   ```
...
N8N_WEBHOOK_URL=https://kenneson.app.n8n.cloud/webhook/kayvila-chat
...
```bash
curl -X POST https://kenneson.app.n8n.cloud/webhook/kayvila-chat \
...
| Variable | Où | Valeur |
|---|---|---|
| `N8N_WEBHOOK_URL` | `.env.local` Next.js | `https://kenneson.app.n8n.cloud/webhook/kayvila-chat` |
