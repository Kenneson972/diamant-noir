  # Prompt Claude Code — Landing propriétaires « Kayvila »
  ...
  - **Marque** : Kayvila — conciergerie / location haut de gamme en Martinique.
  ...
  ```
  Tu travailles sur le projet Next.js 15 (App Router) « kayvila » (Kayvila).
  ...
  - Sections suggérées (ajuste si tu as déjà du contenu réutilisable) :
    ...
    - « Pourquoi Kayvila » (3–4 arguments : visibilité, conciergerie, sérénité, calibrage revenue)
