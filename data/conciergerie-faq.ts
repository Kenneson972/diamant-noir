    ...
    items: [
      {
        ...
        a: "Kayvila ne perçoit pas les loyers à votre place. Vous encaissez directement les paiements voyageurs via la plateforme (Airbnb, Booking, etc.). En fin de mois, Kayvila vous adresse une facture correspondant à sa commission (22 % sur les nuitées pour les réservations directes, 20 % pour les réservations venant des plateformes Airbnb/Booking) sur les nuitées des séjours réalisés, réglable sous 8 jours à réception. Pour simplifier ce règlement, un mandat de prélèvement SEPA peut être mis en place dès la signature du contrat — la commission est alors prélevée automatiquement à date fixe, sans démarche de votre part. Pour les réservations effectuées directement via le site Kayvila, le paiement est scindé à la source : vous recevez votre part et Kayvila perçoit sa commission directement, sans intermédiaire ni facturation mensuelle.",
      },
      {
      ...
      },
      {
        ...
        a: "Pour les réservations via les plateformes (Airbnb, Booking, etc.) : non. La facturation se limite à la commission (22 % sur les nuitées pour les réservations directes, 20 % pour les réservations venant des plateformes Airbnb/Booking) sur les nuitées et au forfait ménage déjà annoncé — aucun frais bancaire ni déduction cachée à votre charge. Pour les réservations effectuées directement via le site Kayvila : non plus. Les frais liés au paiement en ligne sécurisé sont pris en charge par Kayvila et n'ont aucune répercussion sur vous. De votre côté, seule la commission (22 % sur les nuitées pour les réservations directes, 20 % pour les réservations venant des plateformes Airbnb/Booking) s'applique — et comme il n'y a aucune commission de plateforme à déduire, votre net perçu reste supérieur à ce qu'une réservation Airbnb ou Booking vous aurait rapporté.",
      },
      {
