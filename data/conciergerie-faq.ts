    ...
    items: [
      {
        ...
        a: "La commission de 22 % de Kayvila Conciergerie s'applique uniquement sur le montant des nuitées réglé par le voyageur. Les frais de ménage et de blanchisserie sont exclus de la base de commission : vous savez précisément ce sur quoi nous nous rémunérons. Le ménage et la blanchisserie sont facturés aux voyageurs — vous ne les avancez pas et ils n'engendrent aucune facturation supplémentaire pour vous. Le montant par séjour est défini dans l'Annexe Tarifaire.",
      },
      {
      ...
      },
      {
        ...
        a: "Peu importe l'affichage de la plateforme, la commission de 22 % s'applique uniquement sur le montant des nuitées. Si la plateforme intègre le ménage dans le prix affiché, le forfait ménage — défini dans l'Annexe Tarifaire — est déduit du montant encaissé pour reconstituer la base de commission, sans facturation supplémentaire pour vous. Tout est détaillé dans votre rapport mensuel.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "Kayvila ne perçoit pas les loyers à votre place. Vous encaissez directement les paiements voyageurs via la plateforme (Airbnb, Booking, etc.). En fin de mois, Kayvila vous adresse une facture correspondant à sa commission de 22 % sur le montant des nuitées réalisées, réglable sous 8 jours à réception. Pour simplifier ce règlement, un mandat de prélèvement SEPA peut être mis en place dès la signature du contrat — la commission est alors prélevée automatiquement à date fixe, sans démarche de votre part. Pour les réservations effectuées directement via le site Kayvila, le paiement est scindé à la source : vous recevez votre part et Kayvila perçoit sa commission directement, sans intermédiaire ni facturation mensuelle.",
      },
      {
