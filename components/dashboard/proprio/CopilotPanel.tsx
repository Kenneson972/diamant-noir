...
export function CopilotPanel() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed right-0 top-0 z-50 flex h-dvh w-[380px] max-w-[90vw] flex-col bg-white shadow-2xl transition-transform duration-300 ease-out pt-[env(safe-area-inset-top)]",
