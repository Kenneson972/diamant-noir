      ...
      <div className="mx-auto max-w-7xl px-6">
          ...
          <ScrollReveal delay={180}>
            <div>
              ...
              <div className="mb-4 flex items-center gap-3">
                ...
                <a
                  href="https://facebook.com/kayvila"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Facebook Kayvila"
                  className="tap-target border border-black/10 text-navy/50 transition-colors hover:border-black hover:text-black"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-black/10 pt-8 text-xs uppercase tracking-[0.1em] text-navy/40 md:flex-row">
          ...
          <div className="flex flex-wrap justify-center gap-5 md:justify-end">
            <Link href="/mentions-legales" className="transition-colors hover:text-black">
              Mentions légales
            </Link>
            <Link href="/cgv" className="transition-colors hover:text-black">
              CGV
            </Link>
