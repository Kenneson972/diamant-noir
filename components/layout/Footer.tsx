...
function SocialLinks() {
  return (
    <>
      ...
      <a href="#" target="_blank" rel="noopener noreferrer" aria-label="TikTok Kayvila" className="inline-flex h-9 w-9 items-center justify-center border border-black/10 text-navy/50 transition-colors hover:border-black hover:text-black">
