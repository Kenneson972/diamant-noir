...
export function HeroDateRangePicker({
  ...
  return (
    <RangeCalendar
      ...
      className="w-full overflow-x-auto rounded-2xl border border-navy/10 bg-white p-4 text-navy shadow-2xl sm:w-auto"
    >
      <div className="mx-auto flex w-max flex-row gap-6">
        {/* Mois 1 */}
        <div className="w-64">
