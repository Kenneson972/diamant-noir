...
export const CGV_VERSION = "2026-07-01";

/** Texte complet des Conditions Générales de Vente (source unique : pages /cgv + modal checkout). */
export const CGV_FULL = `KAYVILA CONCIERGERIE
Confiance · Réactivité · Excellence

CGV VOYAGEURS
Conditions Générales de Vente — Voyageurs
...
Les présentes Conditions Générales de Vente Voyageurs (les « CGV Voyageurs ») s'appliquent à toute réservation d'un séjour, par un voyageur (ci-après « le Voyageur »), dans un bien géré par Kayvila Conciergerie. Toute réservation implique l'acceptation pleine et entière des présentes CGV Voyageurs.

Article 3 — Prestations assurées par la Conciergerie
La Conciergerie assure l'intermédiaire entre le Voyageur et le Propriétaire pour :
• La mise à disposition du bien loué conformément à l'annonce ;
• Le check-in, physique ou à distance selon les modalités prévues pour le bien ;
• L'assistance pendant le séjour ;
• La gestion des demandes spécifiques dans la limite des services disponibles.

Article 4 — Prix et frais de service
Le prix du séjour est celui indiqué sur l'annonce ou la confirmation de réservation, exprimé toutes taxes comprises et incluant les frais de ménage et de blanchisserie.
Pour les réservations effectuées directement via le site internet de la Conciergerie, aucun frais de service supplémentaire n'est facturé au Voyageur : les coûts liés au traitement du paiement en ligne sont pris en charge par la Conciergerie.
Pour les réservations directes, le contrat de location se forme directement entre le Voyageur et le Propriétaire, la Conciergerie agissant en qualité d'intermédiaire technique de mise en relation et de prestataire de services.
La taxe de séjour n'est pas comprise dans le prix du séjour. Pour les réservations effectuées via les plateformes tierces (Airbnb, Booking.com, etc.), elle est collectée et reversée directement par la plateforme. Pour les réservations directes, la taxe de séjour est perçue auprès du Voyageur en sus du prix du séjour, pour le compte du Propriétaire redevable, conformément aux tarifs fixés par la collectivité compétente. Son montant est indiqué au Voyageur avant la confirmation de la réservation.

Article 5 — Conditions de séjour

5.1 Réservation
La réservation est ferme et définitive à compter de la confirmation émise par la plateforme de réservation ou par la Conciergerie. Le Voyageur reconnaît avoir pris connaissance des caractéristiques du logement et des conditions tarifaires avant toute réservation.

5.2 Modalités de paiement (réservations directes)
Pour les réservations effectuées directement via le site de la Conciergerie, le paiement s'effectue selon les modalités suivantes : un acompte de trente pour cent (30 %) du montant total du séjour est exigé à la réservation pour la confirmer ; le solde est dû au plus tard trente (30) jours avant la date d'arrivée. Pour toute réservation effectuée à moins de trente (30) jours de l'arrivée, le paiement intégral est exigé immédiatement à la réservation.
Dans tous les cas, l'intégralité du montant du séjour doit être réglée avant la remise des clés et l'entrée dans le logement. À défaut de règlement du solde dans le délai imparti, la Conciergerie se réserve le droit d'annuler la réservation, l'acompte restant acquis selon les conditions d'annulation applicables.

5.3 Arrivée et départ
Les horaires d'arrivée (check-in) et de départ (check-out) sont précisés sur la confirmation de réservation. Tout dépassement non autorisé pourra faire l'objet d'une facturation complémentaire.

5.4 Obligations du Voyageur
Le Voyageur s'engage à :
• Utiliser le logement raisonnablement et conformément à sa destination ;
• Ne pas dépasser la capacité d'accueil maximale indiquée ;
• Ne pas céder, revendre ni sous-louer la réservation, en tout ou partie, à un tiers ;
• Respecter l'interdiction de fumer à l'intérieur du logement ; tout manquement pourra donner lieu à une facturation des frais de remise en état (nettoyage approfondi, désodorisation) ;
• N'accueillir aucun animal sans l'accord écrit préalable de la Conciergerie ou mention expresse d'acceptation sur l'annonce ;
• Ne pas organiser d'événements ou de soirées sans accord préalable écrit ;
• Respecter le règlement intérieur du logement remis lors du check-in ;
• Signaler tout dommage ou incident dans les meilleurs délais.

5.5 Dépôt de garantie
Un dépôt de garantie, dont le montant est précisé sur l'annonce, peut être demandé au Voyageur afin de couvrir d'éventuels dommages. Ses modalités varient selon le canal de réservation :
• Réservations directes via le site de la Conciergerie : la garantie prend la forme d'une empreinte bancaire sécurisée (solution de type Swikly), réalisée avant le séjour. Aucun montant n'est débité ni bloqué sur le compte du Voyageur ; l'empreinte expire automatiquement quelques jours après le départ si aucun dommage n'est signalé. En cas de dommage constaté, la Conciergerie peut procéder au prélèvement de tout ou partie de la garantie, sur justificatifs.
• Réservations via les plateformes tierces (Airbnb, Booking.com, etc.) : la garantie et la gestion des éventuels dommages relèvent des dispositifs propres à chaque plateforme (programme de protection de l'hôte, caution, centre de résolution des litiges), selon leurs conditions en vigueur.
Dans tous les cas, un état des lieux d'entrée et de sortie, le cas échéant accompagné de photographies, permet de constater l'état du bien avant et après le séjour.

5.6 Annulation
Pour les réservations effectuées via les plateformes tierces (Airbnb, Booking.com, etc.), les conditions d'annulation applicables sont celles de la plateforme concernée, acceptées par le Voyageur au moment de la réservation.
Pour les réservations directes effectuées via le site de la Conciergerie, la politique d'annulation suivante s'applique et est rappelée au Voyageur avant toute confirmation :
• Annulation plus de 60 jours avant la date d'arrivée : remboursement intégral des sommes versées ;
• Annulation entre 60 et 30 jours avant l'arrivée : l'acompte de 30 % reste acquis à la Conciergerie à titre d'indemnité ; le solde éventuellement versé est remboursé ;
• Annulation à moins de 30 jours de l'arrivée : l'intégralité du montant du séjour reste due et acquise.
En cas de non-présentation du Voyageur (no-show) ou de départ anticipé, aucun remboursement ne pourra être réclamé.
En outre, dès lors que le logement a déjà été préparé en vue de l'arrivée (ménage de préparation, mise en place et changement du code d'accès), les frais de ménage correspondants restent acquis et ne donnent lieu à aucun remboursement, cette préparation constituant un travail effectivement réalisé.

5.7 Droit de rétractation
Conformément à l'article L.221-28 12° du Code de la consommation, le droit de rétractation ne s'applique pas aux prestations d'hébergement fournies à une date ou selon une période d'exécution déterminée. En conséquence, le Voyageur ne dispose d'aucun droit de rétractation à la suite d'une réservation de séjour ; seules les conditions d'annulation prévues à l'article 5.6 s'appliquent.

Article 6 — Responsabilité
La Conciergerie intervient en qualité de prestataire de services et, pour les réservations directes, d'intermédiaire technique. Sa responsabilité est limitée aux prestations de gestion qui lui sont expressément confiées. Elle ne saurait être tenue responsable des vices cachés du logement, des dommages causés par un cas de force majeure, ou des actes du Propriétaire ou du Voyageur. La présente limitation ne s'applique pas aux dommages résultant d'un manquement de la Conciergerie à ses propres obligations, ni dans les cas où la loi, notamment en faveur du consommateur, interdit une telle limitation.
...
Dans le cadre de la réservation et du séjour, la Conciergerie collecte et traite les données suivantes : identité (nom, prénom), coordonnées (email, téléphone, adresse postale), informations relatives au séjour et, le cas échéant, données de paiement et justificatif d'identité (dépôt de garantie). Ces données sont traitées aux fins suivantes : gestion de la réservation et du séjour, encaissement et facturation, gestion du dépôt de garantie, respect des obligations légales, comptables et fiscales, et communication relative au séjour.

7.3 Bases légales
Les traitements reposent, selon le cas, sur l'exécution du contrat (gestion de la réservation et du séjour), le respect d'obligations légales (facturation, comptabilité), l'intérêt légitime de la Conciergerie (sécurité, prévention des impayés) ou le consentement du Voyageur (communications commerciales).

7.4 Destinataires des données
Les données sont destinées à la Conciergerie et, dans la limite de leurs missions respectives, à ses sous-traitants et partenaires : plateformes de réservation, prestataire de paiement sécurisé (notamment Stripe), prestataire de gestion du dépôt de garantie (notamment Swikly), gestionnaire de réservations (channel manager), expert-comptable et, le cas échéant, l'administration compétente. Les données ne sont jamais cédées à des tiers à des fins commerciales sans le consentement préalable du Voyageur, sauf obligation légale.

7.5 Transferts hors Union européenne
...
Les données sont conservées le temps nécessaire à la gestion de la relation, puis archivées conformément aux délais légaux, notamment dix (10) ans pour les pièces comptables. Les données de prospection sont conservées trois (3) ans à compter du dernier contact.

7.7 Droits du Voyageur
Conformément au Règlement (UE) 2016/679 (RGPD) et à la loi n° 78-17 du 6 janvier 1978 modifiée, le Voyageur dispose des droits d'accès, de rectification, d'effacement, de limitation, d'opposition et de portabilité de ses données, du droit de retirer son consentement à tout moment et de définir des directives relatives au sort de ses données après son décès. Ces droits s'exercent par demande adressée à contact@kayvila.com. Le Voyageur dispose également du droit d'introduire une réclamation auprès de la Commission Nationale de l'Informatique et des Libertés (CNIL — www.cnil.fr).

Article 8 — Droit applicable, médiation et litiges
Les présentes CGV Voyageurs sont soumises au droit français.
En cas de litige, le Voyageur est invité à adresser une réclamation écrite à la Conciergerie (contact@kayvila.com) afin de rechercher une solution amiable.

8.1 Médiation de la consommation
Conformément aux articles L.612-1 et suivants du Code de la consommation, le Voyageur ayant la qualité de consommateur a le droit de recourir gratuitement à un médiateur de la consommation en vue de la résolution amiable d'un litige l'opposant à la Conciergerie.
Le recours à la médiation n'est possible qu'à la double condition suivante : le Voyageur doit avoir préalablement adressé une réclamation écrite à la Conciergerie (contact@kayvila.com) et ne pas avoir obtenu de réponse satisfaisante ; et le médiateur doit être saisi dans un délai d'un (1) an à compter de cette réclamation écrite.
La Conciergerie relève du dispositif de médiation suivant : CM2C — 49 rue de Ponthieu, 75008 Paris — www.cm2c.net. Le Voyageur peut saisir le médiateur directement, notamment via son site internet.

8.2 Juridiction compétente
À défaut de résolution amiable ou par voie de médiation, tout litige relatif à l'interprétation ou à l'exécution des présentes sera porté devant les juridictions compétentes selon les règles de droit commun.
...
/** Texte complet des Conditions Générales de Vente Propriétaires (source unique : page /cgv). */
export const CGV_PROPRIETAIRES = `KAYVILA CONCIERGERIE
Confiance · Réactivité · Excellence
