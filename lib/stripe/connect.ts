 ...
 * - Propriétaire : 78 % du montant nuitées (séjour hors ménage/service)
 * - Kayvila : 22 % du séjour + 100 % frais de ménage + 100 % frais de service
 *
 ...
 * @param applicationFeePercent - Commission sur le séjour (défaut 22 %)
 */
export function calculateTransferAmounts(
  stayCents: number,
  cleaningFeeCents: number,
  serviceFeeCents: number,
  applicationFeePercent = 22
